...
grammar Perl6::Parser::Pure::Grammar
  ...
  # {{{ if (statement_control:sym<if>)
   ...
   #   [
   #     [
   #     | 'else'\h*'if' # compiler panic attack
   #     | 'elif'        # also a compiler panic attack
   #     | $<sym>='elsif' <xblock>
   #     | $<sym>='orwith' <xblock>
   #     ]
   #   ]*
